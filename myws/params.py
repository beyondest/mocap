...
onnx_file = 'D:/VS_ws/python/mocap/weights/best11.onnx'
...
VISUALIZE_PLOT = False    # if True, plot the skeleton using matplotlib
USE_CAMERA = True   # if True, use camera to capture video, otherwise use video file
TRANS_H36M = False    # if True, use H36M skeleton, otherwise use COCO skeleton
